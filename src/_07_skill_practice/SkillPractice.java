...
SkillPractice skills = new SkillPractice();
	...
	// Ask the user how many dimes they have
		...
		int dimestotal = dime * 10;
		System.out.println(dimestotal);


		// Ask the user how tall they are (inches)

		String height = JOptionPane.showInputDialog("how tall are you (inches)");
		int high = Integer.parseInt(height);
	...
	void skill3() { // Get a random number that is less than 20 and print it to the console 
		...
		int rando = randomGen.nextInt(20);
		System.out.println(rando);
	
	// Get another random number that is less than 10 and print it to the console 

		int rando1 = randomGen.nextInt(10);
		System.out.println(rando1);

	// Using a pop-up, tell the user the difference between the numbers // Hint: use subtraction 

		int dif = rando - rando1;
	...
	// Otherwise, tell them to move to San Diego 
		 ...
		 JOptionPane.showMessageDialog(null, "too bad, move to san diego");
	 	}
	...
	// If there is more than 1 car, use a pop-up to display how many wheels the // cars have between them. 
		...
		JOptionPane.showMessageDialog(null, "8 wheels between 2 cars");
